...
namespace LevelStrategy.Model
{
    ...
    {
        public SignalData(int rowNumb, string signalType, DateTime bsy, DateTime bpy1, DateTime bpy2, double level, double lyft, double cancelSignal, DateTime now, string name)
        {
            RowNumber = rowNumb;
